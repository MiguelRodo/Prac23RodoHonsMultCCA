---
title: Groups for 2023 honours multivariate CCA section
format:
  pdf:
...
data_raw_participants <- structure(list(V1 = c(
  ...
  "variate pair Der Merwe", "variate pair Huyssteen", "Walbeck", "White", "Whittaker"
), V2 = c(
